...
def main():
    ...
    parser.add_argument("-d", "--db_threshold", type=float, default=-45, help="Decibel threshold for silence detection")
    parser.add_argument("-b", "--buffer_duration", type=float, default=0.25, help="Buffer duration around non-silent parts")
    parser.add_argument("-c", "--chunk_duration", type=int, default=150, help="Duration of video chunks in seconds")
    parser.add_argument("-m", "--min_silence_factor", type=float, default=1.0, help="Minimum silence length as a factor of buffer duration")
